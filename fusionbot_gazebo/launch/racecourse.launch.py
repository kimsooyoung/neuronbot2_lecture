...
def generate_launch_description():
    ...
    current_pkg_path = os.path.join(get_package_share_directory('fusionbot_gazebo'))
    gazebo_model_path2 = os.path.join(current_pkg_path, 'models')
    ...
    world_path = os.path.join(current_pkg_path, 'world', 'racecar_course.world')
