...
#include "custom_nav2_msgs/action/follow_waypoints.hpp"
...
private:
  ...
  using NavigationGoalHandle =
    rclcpp_action::ClientGoalHandle<custom_nav2_msgs::action::NavigateToPose>;
  using WaypointFollowerGoalHandle =
    rclcpp_action::ClientGoalHandle<custom_nav2_msgs::action::FollowWaypoints>;
  ...
  rclcpp_action::Client<custom_nav2_msgs::action::NavigateToPose>::SharedPtr navigation_action_client_;
  rclcpp_action::Client<custom_nav2_msgs::action::FollowWaypoints>::SharedPtr
    waypoint_follower_action_client_;

  // Goal-related state
  custom_nav2_msgs::action::NavigateToPose::Goal navigation_goal_;
  custom_nav2_msgs::action::FollowWaypoints::Goal waypoint_follower_goal_;
